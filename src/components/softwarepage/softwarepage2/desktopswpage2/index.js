...
const DesktopSwPage2 = () => {
  ...
  return (
    <FirstDiv>
      <GridContainer>
        <GridContainerItem>
          <div className="hover-target" onClick={handleClickSw}>
            <FourthTitle>ITC MastAR Chef</FourthTitle>
            <FourthText2>
