...
const DesktopSoftwarePage4 = () => {
  const handleClickSw4 = () => {
  ...
  return (
    <FirstDiv>
      <GridContainer>
        <GridContainerItem>
          <div className="hover-target" onClick={handleClickSw4}>
            <FourthTitle>Saffola Aura Launch</FourthTitle>
            <FourthText2>
...
export default DesktopSoftwarePage4
