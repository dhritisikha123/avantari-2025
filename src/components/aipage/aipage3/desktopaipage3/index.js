...
const DesktopAiPage3 = () => {
  const handleClickDecs = () => {
    navigate("/decsai")
  }
  return (
    <FirstDiv>
      <GridContainer>
        <GridContainerItem style={{ gridColumn: "span 2" }}>
          <ImageContainer
            ...
            onClick={handleClickDecs}
          />
        </GridContainerItem>
        <GridContainerItem>
          <div className="hover-target" onClick={handleClickDecs}>
            <FourthTitle>DECS.AI</FourthTitle>
            <FourthText2>
