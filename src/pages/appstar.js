...
import seoImg from "../images/og-images/appStarOG.png"
import playButtonIcon from "../images/newWeb/icons/play.svg"

import appstarLanding from "../images/newWeb/appstar/appstarLanding.png"
import appstarPage2 from "../images/newWeb/appstar/appstarPage2.png"
import appstarPlayButton1 from "../images/newWeb/appstar/appStarPlay.png"
import appstarVid2 from "../images/newWeb/appstar/appstarVid2.mp4"
    ...
    <Layout footerVariant="dark">
      <PageWrapper>
        <HeroSection>
          <HeroGrid>
            <HeroContent>
              <Eyebrow $color="#547300">SOFTWARE / RAMANAIDU STUDIOS</Eyebrow>
              <HeroTitle>AppStar</HeroTitle>
              <CommonSubtitle>
                Film stars, stepping out of the poster. Tracked live, in
                cinema-foyer light, with no marker.
              </CommonSubtitle>
              <HeroBodyPara>
                An augmented reality app for the Telugu film Nene Raju Nene
                Mantri that let fans photograph themselves standing with Rana
                Daggubati and Kajal Aggarwal.
              </HeroBodyPara>
            </HeroContent>
            <HeroImages>
              <img src={appstarLanding} alt="ARXAR" />
            </HeroImages>
          </HeroGrid>
          <MetaBar>
            {meta.map(item => (
          ...
          <SplitGrid>
            <ContentBox $bg="#c3ff00">
              ...
              <CommonTitle $maxWidth="420px">
                Turn film marketing into something fans could enter.
              </CommonTitle>
              <BodyPara>
                Ramanaidu Studios wanted a launch campaign people would take
                part in rather than simply watch — one that ended with a
            ...
            <ContentBox $bg="#000000">
              ...
              <CommonTitle style={{ color: `#fff` }} $maxWidth="420px">
                The magic had to survive the real world.
              </CommonTitle>
              <BodyPara style={{ color: `#8C8C8C` }}>
                It had to recognise a paper poster in the unpredictable light of
                a cinema foyer, run on whatever phone a fan was carrying, and
                place the star convincingly in the scene.
              </BodyPara>
            </ContentBox>
          </SplitGrid>
        </Section>
        ...
        <div style={{ backgroundColor: `#000` }}>
          <FilmSection>
            <Padded>
              <Eyebrow style={{ color: `#C3FF00` }}>FILM / APPSTAR</Eyebrow>
              <VideoFrame onClick={handlePlay}>
                {!playing && (
                  <img src={appstarPlayButton1} alt="NARI launch film" />
                )}
                <video
                  preload="auto"
                  controls={playing}
                ...
                >
                  <source src={appstarVid2} type="video/mp4" />
                </video>
                {!playing && (
              ...
              <FilmCaption style={{ color: `#8C8C8C` }}>
                A star, stepping out of a poster.
              </FilmCaption>
            </Padded>
          </FilmSection>
        </div>
        ...
        <Section>
          <SplitGrid>
            <ContentBox>
              <Eyebrow>THE INTERACTION</Eyebrow>
              <CommonTitle>Point at the poster.</CommonTitle>
              <BodyPara>
                Fans aimed a phone at any film poster and the star stepped out
                of it. The whole thing resolves into one picture — the fan,
                standing beside the star. Cinemas ran it in their foyers, which
                turned distribution into part of the campaign.
              </BodyPara>
              <Tag>
                <TagTitle>A photo worth sharing</TagTitle>
                <TagText>Social sharing carried the campaign for free.</TagText>
              </Tag>
            </ContentBox>
            <ImageBox>
              <img src={appstarPage2} />
            </ImageBox>
          </SplitGrid>
        </Section>
        ...
        <div style={{ backgroundColor: `#000` }}>
          <RecordSection style={{ backgroundColor: `#000` }}>
            <Padded style={{ backgroundColor: `#000` }}>
              <Eyebrow style={{color:`#C3FF00`}}>WHAT HAPPENED</Eyebrow>
              <CommonTitle1 style={{ color: `#fff` }}>
                500,000+ downloads around a ₹450M box-office release.
              </CommonTitle1>
              <RecordStatGrid>
          ...
          <Padded style={{ backgroundColor: `transparent` }}>
            <QuoteGrid>
              <div>
                ...
                <Eyebrow>
                  Producer; Managing Director, Suresh Productions
                </Eyebrow>
              </div>
              <QuoteText>
                “AppStar turned a film poster into an experience fans could
                enter. It was immediate, easy to use in cinema foyers, and
                produced the one thing audiences wanted to share: a photograph
                with the stars.”
              </QuoteText>
            </QuoteGrid>
          </Padded>
        ...
        <NavSection>
          ...
          <NavBlock>
            ...
            <NavLink to="/ar-ar">ARXAR →</NavLink>
          </NavBlock>
        </NavSection>
      </PageWrapper>
    </Layout>
...
const canonicalUrl = "https://www.avantari.org/appstar"

export const Head = () => (
  <>
    <Seo
      title="AppStar Augmented Reality Film Campaign | Avantari"
      description="How Avantari built AppStar, an AR cinema campaign that brought film stars out of posters and into fan photographs in unpredictable real-world conditions."
      image={seoImg}
      url={canonicalUrl}
    />
    ...
    <meta
      name="keywords"
      content="augmented reality campaign, AR app development, film marketing technology, marker tracking, mobile experiential campaign"
    />
  </>
)
