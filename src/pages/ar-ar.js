...
import seoImg from "../images/og-images/arOG.png"
...
const recordStats = [
  {
    label: "1 MILLION+",
    text: "Downloads, at a four-star rating.",
  },

  {
    label: "#1",
    text: "Most downloaded AR app on the App Store.",
  },
]
    ...
    <Layout footerVariant="dark">
      <PageWrapper>
        <HeroSection>
          <HeroGrid>
            <HeroContent>
              <Eyebrow $color="#547300">SOFTWARE / AR RAHMAN</Eyebrow>
              <HeroTitle>ARxAR</HeroTitle>
              <CommonSubtitle>
                A life-size AR Rahman, anywhere you stand. Placed by detecting
                the floor with nothing to aim at.
              </CommonSubtitle>
              <HeroBodyPara>
                An augmented reality app that let fans place AR Rahman in their
                own room, at full scale, and take a photograph with him.
              </HeroBodyPara>
            </HeroContent>
            <HeroImages>
              <img src={arLanding} alt="ARXAR" />
            </HeroImages>
          </HeroGrid>
          <MetaBar>
            {meta.map(item => (
          ...
          <SplitGrid>
            <ContentBox $bg="#c3ff00">
              ...
              <CommonTitle $maxWidth="420px">
                Let a million fans stand beside AR Rahman.
              </CommonTitle>
              <BodyPara>
                AR Rahman wanted to meet his audience personally at a scale no
                tour could reach. The encounter had to feel like presence, not
                like a filter.
              </BodyPara>
            </ContentBox>
            <ContentBox $bg="#000000">
              ...
              <CommonTitle style={{ color: `#fff` }} $maxWidth="420px">
                Presence had to work without a marker.
              </CommonTitle>
              <BodyPara style={{ color: `#8C8C8C` }}>
                A life-size figure only feels real when it belongs to the room.
                The app had to find the floor instantly, with nothing printed
                for the camera to aim at.
              </BodyPara>
            </ContentBox>
          </SplitGrid>
        </Section>
        ...
        <div style={{ backgroundColor: `#000` }}>
          <FilmSection>
            <Padded>
              <Eyebrow style={{ color: `#C3FF00` }}>FILM / ARXAR</Eyebrow>
              <VideoFrame onClick={handlePlay}>
                {!playing && <img src={arPlayButton} alt="NARI launch film" />}
                <video
                  preload="auto"
                  controls={playing}
                  playsInline
                ...
                >
                  <source src={arVid} type="video/mp4" />
                </video>
                {!playing && (
        ...
        <div style={{ backgroundColor: `#fff` }}>
          <Section>
            <SplitGrid>
              <ContentBox>
                <Eyebrow>THE BREAKTHROUGH</Eyebrow>
                <CommonTitle>
                  First to find the floor without a marker.
                </CommonTitle>
                <BodyPara>
                  Placing a life-size figure convincingly meant detecting the
                  ground plane instantly, with nothing printed to aim the camera
                  at. Built on Apple’s ARKit, the app found the floor on sight.
                </BodyPara>
                <Tag>
                  <TagTitle>Full scale</TagTitle>
                  <TagText>
                    Life-size presence is what made the photographs feel real.
                  </TagText>
                </Tag>
              </ContentBox>
              <ImageBox>
        ...
        <div style={{ backgroundColor: `#C3FF00` }}>
          <RecordSection style={{ backgroundColor: `#C3FF00` }}>
            <Padded style={{ backgroundColor: `#C3FF00` }}>
              ...
              <CommonTitle1>
                The most downloaded AR app on the App Store.
              </CommonTitle1>
              <RecordStatGrid>
        ...
        <div style={{ backgroundColor: `#fff` }}>
          <RecordSection style={{ backgroundColor: `#fff` }}>
            <Padded style={{ backgroundColor: `#fff` }}>
              <Eyebrow $color="#1f1f1f">COVERAGE</Eyebrow>
          ...
          <Padded style={{ backgroundColor: `transparent` }}>
            <QuoteGrid>
              <div>
                ...
                <Eyebrow>Composer and artist</Eyebrow>
              </div>
              <QuoteText>
                “ARxAR let fans meet me somewhere a concert never could: in
                their own room. It made a digital interaction feel immediate,
...
const canonicalUrl = "https://www.avantari.org/ar-ar"

export const Head = () => (
  <>
    <Seo
      title="ARxAR: Life-Size AR Rahman App | Avantari"
      description="How Avantari built ARxAR, an augmented reality app that placed a life-size AR Rahman in any room using markerless floor detection."
      image={seoImg}
      url={canonicalUrl}
    />
    ...
    <meta
      name="keywords"
      content="AR Rahman augmented reality app, markerless AR, floor detection, ARKit development, celebrity fan experience"
    />
  </>
)

export default ARARNew
